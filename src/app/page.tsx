    ...
    <section>
      ...
      <div className="relative w-full h-screen overflow-hidden bg-lab-900">
        ...
        <div className="relative z-10 flex flex-col justify-end h-full section-wrapper pb-16 md:pb-24">
          <h1 className="text-[5.1rem] md:text-[7.65rem] font-sans font-semibold text-white/65 leading-none tracking-tight mb-4">
            placeLab
          </h1>
          <p className="text-xl md:text-[1.9rem] text-white/65 font-sans">
